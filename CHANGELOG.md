...
- Prevented managed inputs and `apply` destinations from overlapping the active private `susu` state directory, repository worktree, or Git common administrative directory.
